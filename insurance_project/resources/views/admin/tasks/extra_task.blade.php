    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-md-5 align-self-center">
                <h3 class="page-title">Add Extra Task</h3>
                    ...
                    <div class="dropdown me-2">
                     ...
                     <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><button id="forceDeleteSelected" class="confirm dropdown-item"
                                    onclick="forceDeleteSelected()">Delete Selected</button></li>
                        </ul>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-3 pb-3 border-bottom">Add New Extra Task :</h4>
                        <form action="{{ route('super_admin.tasks-storeExtraTask') }}" method="POST"
                                            ...
                                            @if (isset($myProjects) && $myProjects->count() > 0)
                                                ...
                                                @foreach ($myProjects as $project)
                                                    <option value="{{ $project->project_id }}"
                                                        @if (old('project_id') == $project->project_id) selected @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating mb-3">
                                        <input type="date" name="task_end_date"
                                            ...
                                            id="tb-name" value="{{ old('task_end_date') }}"
                                            placeholder="Task Start Date">
                                        <label for="tb-name">
                                            <i data-feather="type" class="feather-sm text-info fill-white me-2"></i>Task
                                            End Date
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating mb-3">
                                        <input type="number" step=".01" name="actual_time"
                                            ...
                                            id="tb-name" value="{{ old('actual_time') }}" placeholder="Estimated Time">
                                        <label for="tb-name">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="button-group">
                                                    ...
                                                    <a href="{{ route('super_admin.tasks-destroyExtraTask', isset($task->id) ? $task->id : -1) }}"
     ...
     <script>
        function forceDeleteSelected() {
            ...
            if (selectedTasks.length > 0) {
                ...
                var link = '{{ route('super_admin.tasks-forceDeleteSelected') }}' + query;

    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-md-5 align-self-center">
                <h3 class="page-title">All Projects In Queue
                    @if (isset($projectsInQueue))
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">All Projects In Queue</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title mb-0">All Projects In Queue</h4>
                    </div>
                    <div class="card-body">
                        {{-- Statistics Section --}}
                        {{-- <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table id="file_export_projects_in_queue" class="table table-striped table-bordered display">
                                ...
                                <tbody>
                                    @foreach ($projectsInQueue as $projectInQueue)
                                        <tr>
                                            <td><a
                                                    href="{{ route('super_admin.projects-show', isset($projectInQueue->id) ? $projectInQueue->id : -1) }}">
                                                    <strong>
                                                        {{ isset($projectInQueue->id) ? $projectInQueue->id : '----' }}
                                                    </strong>
                                                </a>
                                            </td>
                                            ...
                                            <td><a
                                                    href="{{ route('super_admin.projects-show', isset($projectInQueue->id) ? $projectInQueue->id : -1) }}">
                                                    <strong>
                                                        {{ isset($projectInQueue->name_ar) ? $projectInQueue->name_ar : '----' }}
                                                    </strong>
                                                </a>
                                            </td>

                                            <td><a
                                                    href="{{ route('super_admin.projects-show', isset($projectInQueue->projects->id) ? $projectInQueue->projects->id : -1) }}">
                                                    <strong>
                                                        {{ isset($projectInQueue->name_en) ? $projectInQueue->name_en : '----' }}
                                                    </strong>
                                                </a>
                                            </td>
                                            ...
                                            {{-- customer --}}
                                            <td><a
                                                    href="{{ route('super_admin.customers-show', isset($projectInQueue->customer->id) ? $projectInQueue->customer->id : -1) }}">
                                                    <strong>{{ isset($projectInQueue->customer->name_en) ? $projectInQueue->customer->name_en : '----' }}
                                                    </strong>
                                                </a>
                                            </td>
                                            ...
                                            <td>{!! isset($projectInQueue->created_at)
                                                ? '<strong>Date : </strong>' .
                                                    date('Y -m-d', strtotime($projectInQueue->created_at)) .
                                                    '<br><strong>Time : </strong>' .
                                                    date('h:i A', strtotime($projectInQueue->created_at)) .
                                                    '<br><strong>Since : </strong> ' .
                                                    $projectInQueue->created_at->diffForHumans()
                                            ...
                                            <td>
                                                <span style="color: orange">
                                                    <strong>
                                                        {{ isset($projectInQueue->status) ? $projectInQueue->status : '----' }}
                                                    </strong>
                                                </span>
                                            </td>
                                            <td>
                                                <span style="color: green">
                                                    <strong>
                                                        {{ isset($projectInQueue->total_contracts) ? $projectInQueue->total_contracts : '----' }}
                                                        JOD
                                                    </strong>
                                                </span>
                                            </td>
                                            ...
                                            {{-- <td>
                                                <div class="button-group">
                                                    <a href="{{ route('super_admin.projects-show', isset($projectInQueue->id) ? $projectInQueue->id : -1) }}"
                                                        class="btn waves-effect waves-light btn-primary btn-sm"
                                                        title="View Details"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route('super_admin.projects-edit', isset($projectInQueue->id) ? $projectInQueue->id : -1) }}"
                                                        class="btn waves-effect waves-light btn-secondary btn-sm"
                                                        title="Edit"><i class="fas fa-edit"></i></a>
                                                    <a href="{{ route('super_admin.projects-softDelete', isset($projectInQueue->id) ? $projectInQueue->id : -1) }}"

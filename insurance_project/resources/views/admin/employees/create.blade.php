            ...
            <div class="d-flex">
                ...
                <div class="dropdown me-2">
                    <a href="{{ route('super_admin.employees-showSoftDelete') }}" class="btn btn-danger">
                        <i data-feather="archive" class="fill-white feather-sm"></i> View Archived Employees
                    </a>
                </div>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3 pb-3 border-bottom">Add New Employee :</h4>
                    <form action="{{ route('super_admin.employees-store') }}" method="POST" id="signUpForm"
                        ...
                        <div class="row">
                            ...
                            <div class="phone_from border-info col-md-6 ">
                                ...
                                <select name="country_phone_id" class="numbersList text-center col-md-4"
                                    ...
                                    <option value="{{ $phone_key->id }}" @if (old('country_phone_id')==$phone_key->id)
                                        selected @endif>

                                        {{ isset($phone_key->phone_code) ? $phone_key->name_en . ' (' .
                                        $phone_key->phone_code . '+)' : '------' }}
                                ...
                                <div class="mb-3">
                                    <div class="form-floating mb-3">
                                        <select name="department_id"
                                            ...
                                            <option value="{{ $department->id }}" @if(old('department_id')==$department->id) selected @endif>{{ isset($department->name) ? $department->name : '------' }}
                                            </option>
                                            @endforeach
                                            @else
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <select name="nationality" required
                                        ...
                                        style="width: 100%">
                                        @if (isset($countries) && $countries->count() > 0)
                                        <option value="">Select Nationality <span>*</span></option>
                                        <option value="112" @if (old('nationality')=='112' || !old('nationality'))
                                            selected @endif>
                                            Jordan (الاردن)</option>
                                        ...
                                        @endforeach
                                        @else
                                        <option value="">No Nationality Are Available</option>
                                        @endif
                                    </select>
                                    <strong class="text-danger">
                                        @error('nationality')
                                ...
                                <div class="mb-3">
                                    <div class="form-floating mb-3">
                                        <select name="employee_type_id"
                                            ...
                                            <option value="{{ $employee_type->id }}"{{old('employee_type_id')==$employee_type->id ? 'selected' : ''}}>{{ $employee_type->title_en }} </option>
                                            @empty
                                            @endforelse
                                        </select>
                                        <label for="tb-name">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating mb-3">
                                        <select name="gender"
                                            ...
                                            <option value="1" @if (old('gender')==1) selected @endif @if (old('gender'))
                                ...
                                <div class="mb-3">
                                    <div class="form-floating mb-3">
                                        <select name="marital_status"
                                            ...
                                            <option value="1" @if (old('marital_status')==1) selected @endif @if (old('marital_status')) selected @endif>Single </option>
                                            <option value="2" @if (old('marital_status')==2) selected @endif>
                                                Married </option>
                                            <option value="3" @if (old('marital_status')==3) selected @endif>
                                                Divorced </option>
                                            <option value="4" @if (old('marital_status')==4) selected @endif>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="date" name="date_of_birth"
                                        ...
                                        id="tb-date_of_birth" value="{{ old('date_of_birth') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="email" name="work_email"
                                        ...
                                        id="tb-work_email" value="{{ old('work_email') }}" placeholder="Work Email">
                            ...
                            <div class="phone_from border-info col-md-6 ">
                                ...
                                <select name="work_country_phone_id" class="numbersList text-center col-md-4"
                                    ...
                                    <option value="">--- Select Country Code ---</option>
                                    @foreach ($countries as $phone_key)
                                    <option value="{{ $phone_key->id }}" @if (old('work_country_phone_id')==$phone_key->
                                        id) selected @endif>
                                ...
                                <div class="form-floating mb-3 col-md-8">
                                    <input type="number" name="work_phone" min="0"
                                        ...
                                        id="tb-phone" value="{{ old('work_phone') }}" placeholder="Phone">
                                    <label for="tb-phone">
                                        <i data-feather="type" class="feather-sm text-info fill-white me-2"></i> Work
                                        Phone
                                        <strong class="text-danger">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="date" name="date_of_hiring"
                                        ...
                                        id="tb-date_of_hiring" value="{{ old('date_of_hiring') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="date" name="date_termination"
                                        ...
                                        id="tb-date_termination" value="{{ old('date_termination') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" name="salary" min="0" step="0.001"
                                        ...
                                        id="tb-salary" value="{{ old('salary') }}" placeholder="Salary">
                                    <label for="tb-salary">
                            ...
                            for (var prop in obj) {
                                ...
                                if (city_id_old_value) {
                                    if (obj.id == city_id_old_value) {
                                        ...
                                        selectCities += '<option value="' + obj.id + '">' + obj.name_ar + ' ' + '(' + (obj.name_en) + ')'+ '</option>';
                                    }
                                } else {
                                    selectCities += '<option value="' + obj.id + '">' + obj.name_ar + ' ' +  '(' + (obj.name_en) + ')' + '</option>';
                                }

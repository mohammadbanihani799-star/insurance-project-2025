...
<!-- ============================================================== -->
<footer class="footer">
    &copy; <span id="copy-year">2024</span> Copyright | All rights reserved
</footer>
<!-- ============================================================== -->
<!-- End footer -->
<!-- ============================================================== -->
                        ...
                        <div class="message-center chat-scroll position-relative">
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/1.jpg') }}"
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/2.jpg') }}"
                                        alt="user" class="rounded-circle w-100">
                                ...
                                <div class="w-75 d-inline-block v-middle ps-3">
                                    <h5 class="message-title mb-0 mt-1">Sonu Nigam</h5> <span
                                        ...
                                        song! See you at</span> <span class="fs-2 text-nowrap d-block text-muted">9:10
                                        AM</span>
                                </div>
                            </a>
                            <!-- Message -->
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/3.jpg') }}"
                                        alt="user" class="rounded-circle w-100">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/4.jpg') }}"
                                        alt="user" class="rounded-circle w-100">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/5.jpg') }}"
                                        alt="user" class="rounded-circle w-100">
                                    <span class="profile-status rounded-circle offline"></span> </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/6.jpg') }}"
                                        alt="user" class="rounded-circle w-100">
                                    <span class="profile-status rounded-circle offline"></span> </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/7.jpg') }}"
                                        alt="user" class="rounded-circle w-100">
                                    <span class="profile-status rounded-circle offline"></span> </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                                    <h5 class="message-title mb-0 mt-1">Pavan kumar</h5> <span
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block"> <img
                                        src="{{ asset('style_files/backend/src/assets/images/users/8.jpg') }}"
                                        alt="user" class="rounded-circle w-100">
                                    <span class="profile-status rounded-circle offline"></span> </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                ...
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="rounded-circle" alt="user"
                                src="{{ asset('style_files/backend/src/assets/images/users/2.jpg') }}"> </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="rounded-circle" alt="user"
                                src="{{ asset('style_files/backend/src/assets/images/users/1.jpg') }}"> </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="rounded-circle" alt="user"
                                src="{{ asset('style_files/backend/src/assets/images/users/4.jpg') }}"> </div>
                        <div class="sl-right">
                            <div class="font-weight-medium">Go to the Doctor <span class="sl-date">5 minutes
                                    ago</span>
                            </div>
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="rounded-circle" alt="user"
                                src="{{ asset('style_files/backend/src/assets/images/users/6.jpg') }}"> </div>
                        <div class="sl-right">
                            <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span>
                            </div>
                            <div class="desc">Approve meeting with tiger</div>

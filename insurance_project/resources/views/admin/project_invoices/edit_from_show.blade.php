            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form
                            action="{{ route('super_admin.project_invoices-updateInvocieFromShow', isset($projectInvoice->id) ? $projectInvoice->id : -1) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" name="amount" min="1" max="{{ $totalMaxAmount }}"
                                            step="0.001"

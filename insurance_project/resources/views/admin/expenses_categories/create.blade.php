    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('super_admin.expenses_categories-store') }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title_ar"
                                            ...
                                            id="tb-title-ar" value="{{ old('title_ar') }}" placeholder="Title AR">
                                        <label for="tb-title-ar">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title_en"
                                            ...
                                            id="tb-title-en" value="{{ old('title_en') }}" placeholder="Title EN">
                                        <label for="tb-title-en">
                                            <i data-feather="type" class="feather-sm text-info fill-white me-2"></i> Title
                                            EN
                                            <strong class="text-danger">
                                                @error('title_en')
                                    ...
                                    <div class="mb-3">
                                        <div class="form-floating mb-3">
                                            <select name="status"
                                                ...
                                                <option>--- Choose Expense Category Status ---</option>

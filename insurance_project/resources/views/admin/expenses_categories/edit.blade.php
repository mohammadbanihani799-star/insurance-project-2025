        ...
        <div class="row">
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Expense Category Info</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-md-7 justify-content-end align-self-center d-none d-md-flex">
                <div class="d-flex">
                    ...
                    {{-- Show --}}
                    <div class="dropdown me-2">
                        <a href="{{ route('super_admin.expenses_categories-show', isset($expenseCategory->id) ? $expenseCategory->id : -1) }}"
                            class="btn btn-primary">
                            <i data-feather="eye" class="fill-white feather-sm"></i> View Expense Category
                        </a>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form
                            action="{{ route('super_admin.expenses_categories-update', isset($expenseCategory->id) ? $expenseCategory->id : -1) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title_ar"
                                            ...
                                            id="tb-title_ar"
                                            value="{{ old('title_ar') ? old('title_ar') : (isset($expenseCategory->title_ar) ? $expenseCategory->title_ar : null) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title_en"
                                            ...
                                            id="tb-title_en"
                                            value="{{ old('title_en') ? old('title_en') : (isset($expenseCategory->title_en) ? $expenseCategory->title_en : null)}}"
                                    ...
                                    <div class="mb-3">
                                        <div class="form-floating mb-3">
                                            <select name="status"
                                                ...
                                                <option value="1" {{ old('status')  ? (old('status') == 1 ? 'selected' : '') : (($expenseCategory->status == 'Active') ? 'selected' : '') }}
                                                    >Active</option>
                                                    
                                                <option value="2" {{ old('status') ? (old('status') == 2 ? 'selected' : '') : (($expenseCategory->status == 'Inactive') ? 'selected' : '') }}>
                                                    Inactive </option>
                                            </select>

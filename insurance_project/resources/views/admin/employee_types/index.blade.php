...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-md-5 align-self-center">
            <h3 class="page-title">Employees Types
            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Employees Types</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="col-md-7 justify-content-end align-self-center d-none d-md-flex">
            <div class="d-flex">
                ...
                {{-- Archive --}}
                <div class="dropdown me-2">
                    <a href="{{ route('super_admin.employee_types-showSoftDelete') }}" class="btn btn-danger">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="file_export" class="table table-striped table-bordered display">
                            ...
                            <tbody>
                                @forelse ($employeesTypes as $departmentsType)
                                <tr>
                                    {{-- title_ar --}}
                                    <td>
                                    ...
                                    {{-- No.Employees --}}
                                    <td>
                                        <strong>{{ isset($departmentsType->users) ?
                                            $departmentsType->users->count() :
                                            '----' }}</strong>
                                    </td>
                                    {{-- created_at --}}
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('super_admin.employee_types-activeInactiveSingle', isset($departmentsType->id) ? $departmentsType->id : -1) }}"
                                    ...
                                    <td>
                                        <div class="button-group">
                                            ...
                                            <a href="{{ route('super_admin.employee_types-edit', isset($departmentsType->id) ? $departmentsType->id : -1) }}"
                                                class="btn waves-effect waves-light btn-secondary btn-sm"
                                                title="Edit"><i class="fas fa-edit"></i></a>
                                            <a href="{{ route('super_admin.employee_types-softDelete', isset($departmentsType->id) ? $departmentsType->id : -1) }}"

        ...
        <div class="row">
            ...
            <div class="col-md-7 justify-content-end align-self-center d-none d-md-flex">
                <div class="d-flex">
                    ...
                    {{-- Delete --}}
                    <div class="dropdown me-2">
                        <a href="{{ route('super_admin.employee_types-softDelete', isset($expenseCategory->id) ? $expenseCategory->id : -1) }}"
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form
                            action="{{ route('super_admin.employee_types-update', isset($expenseCategory->id) ? $expenseCategory->id : -1) }}"

                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Subscription Type Info</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown me-2">
                        <a href="{{ route('super_admin.subscriptions_types-create') }}" class="btn btn-dark">
                            <i data-feather="plus" class="fill-white feather-sm"></i>New Subscription Type
                        </a>
                    </div>
                    ...
                    {{-- Delete --}}
                    <div class="dropdown me-2">
                        <a href="{{ route('super_admin.subscriptions_types-softDelete', isset($subscriptionType->id) ? $subscriptionType->id : -1) }}"
                            class="confirm btn btn-danger">
                            <i data-feather="trash" class="fill-white feather-sm"></i> Delete Subscription Type
                        </a>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form
                            action="{{ route('super_admin.subscriptions_types-update', isset($subscriptionType->id) ? $subscriptionType->id : -1) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title_ar"
                                            ...
                                            id="tb-title_ar"
                                            value="{{ isset($subscriptionType->title_ar) ? $subscriptionType->title_ar : null }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title_en"
                                            ...
                                            id="tb-title_en"
                                            value="{{ isset($subscriptionType->title_en) ? $subscriptionType->title_en : null }}"
                                    ...
                                    <div class="mb-3">
                                        <div class="form-floating mb-3">
                                            <select name="status"
                                                ...
                                                <option value="1" @if ($subscriptionType->status == 'Active') selected @endif
                                                    @if ($subscriptionType->status == null) selected @endif>Active</option>
                                                <option value="2" @if ($subscriptionType->status == 'Inactive') selected @endif>
                                                    Inactive </option>
                                            </select>

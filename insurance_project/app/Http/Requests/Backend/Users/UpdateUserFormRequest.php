...
class UpdateUserFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules =  [
            ...
            'password' => ['nullable', Password::min(7)->mixedCase()->numbers()->symbols(), 'confirmed'],
        ...
        $rules['phone'] = [
            ...
            'regex:/^[\d]{5,15}$/'
        ]; // Note: Keep [] on regex validation, there is a case here
    ...
    public function messages()
    {
        return [
            ...
            'employee_type_id.nuumeric' => 'User Type must be a number !!',
            'employee_type_id.in' => 'User Type value is not valid',

...
class StoreSubscriptionTypeFormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
     $statusArray = [1, 2]; // 1 => Active, 2 => Inactive 
        $rules = [
                'title_ar' => 'required|unique:subscriptions_types,title_ar',
                'title_en' => 'required|unique:subscriptions_types,title_en',
